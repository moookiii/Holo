...
BODY = 'M185 284 Q128 253 81 147 Q205 181 294 207 Q383 182 499 232 Q573 197 648 185 Q681 179 631 250 L573 323 Q600 340 611 374 Q626 424 590 468 Q634 494 658 549 Q677 597 649 634 Q693 703 692 784 Q696 849 661 881 Q596 930 548 949 Q405 983 323 946 Q238 1007 121 950 Q44 917 38 857 C24 786 40 700 57 638 C78 554 111 459 143 380 Q169 318 185 284 Z'
...
# The print already defines the silhouette and left fingers. A second raised
...
edge = np.maximum.reduce([mask(p, 1.6) for p in [RIGHT_ARM, LEFT_CHEEK, RIGHT_CHEEK, LEFT_EYE, RIGHT_EYE, MOUTH, BELLY]])
