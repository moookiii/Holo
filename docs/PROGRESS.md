...
Current priority: the user superseded the additional Yu-Gi-Oh! and original-card plans with Magic: The Gathering. Add Angel of Serenity using the exact supplied front and Magic back, then research and implement the strongest visually distinct Magic foils. Halo, Surge and Fracture are the first specialty candidates, with Traditional as a foundation. These are treatment studies on the supplied C21 print, not claims of actual specialty printings. Preserve all accepted Pokémon, original and Yu-Gi-Oh! work, especially Blue-Eyes and Tinsel. Later sequencing notes below are historical.
