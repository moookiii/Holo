...
| Rare | 21 | — | Eight Eeveelutions authored; 13 picture/border masks pending |
...
`prismaticPickerCards()`; currently those are the eight authored regular holos and
...
Leafeon 005, Flareon 013, Vaporeon 022, Glaceon 025, Jolteon 029,
Espeon 033 and Sylveon 040 each have separate subject contours;
...
Glaceon's long head ribbons and Jolteon's fur spikes remain opaque. Espeon's
forked tail and small foreleg opening preserve the foil upholstery behind it.
Sylveon's bows and individual ribbons preserve each intervening background loop.
Espeon and Sylveon use their stepped upper-right art boundary.
Their source/region manifests accompany the PNG maps. Rebuild these seven with
