...
const pokemon = [
  ...
  ['beedrill', 'Beedrill', '17/102'], ['dragonair', 'Dragonair', '18/102'], ['dugtrio', 'Dugtrio', '19/102'], ['electabuzz', 'Electabuzz', '20/102'],
  ['electrode', 'Electrode', '21/102'], ['pidgeotto', 'Pidgeotto', '22/102'], ['arcanine', 'Arcanine', '23/102'], ['charmeleon', 'Charmeleon', '24/102'],
  ['dewgong', 'Dewgong', '25/102'], ['dratini', 'Dratini', '26/102'], ["farfetchd", "Farfetch'd", '27/102'], ['growlithe', 'Growlithe', '28/102'],
  ['haunter', 'Haunter', '29/102'], ['ivysaur', 'Ivysaur', '30/102'], ['jynx', 'Jynx', '31/102'], ['kadabra', 'Kadabra', '32/102'],
  ['kakuna', 'Kakuna', '33/102'], ['machoke', 'Machoke', '34/102'], ['magikarp', 'Magikarp', '35/102'], ['magmar', 'Magmar', '36/102'],
  ['nidorino', 'Nidorino', '37/102'], ['poliwhirl', 'Poliwhirl', '38/102'], ['porygon', 'Porygon', '39/102'], ['raticate', 'Raticate', '40/102'],
  ['seel', 'Seel', '41/102'], ['wartortle', 'Wartortle', '42/102'], ['abra', 'Abra', '43/102'], ['caterpie', 'Caterpie', '45/102'],
  ['doduo', 'Doduo', '48/102'], ['magnemite', 'Magnemite', '53/102'], ['paras', 'Paras', '57/102'], ['rattata', 'Rattata', '61/102'],
  ['starmie', 'Starmie', '64/102'], ['tangela', 'Tangela', '66/102'],
] as const;
