...
export function createMaterialLab(context: LabContext) {
  ...
  for (const [name, key, min, max, step] of [
    ...
    ['Pattern roughness', 'patternRoughness', -.3, .3, .01],
    ['Laminate', 'laminate', 0, 1, .01], ['Laminate roughness', 'laminateRoughness', .06, .5, .01],
    ['Diffraction facet slope', 'facetTilt', 0, 1.5, .01], ['Reflection coupling', 'reflectionCoupling', 0, 1, .01], ['Anisotropy', 'anisotropy', 0, 1, .01],
